define(function (require) {
    ...
    return [
        ...
        {
            'menu' : '<div class="fondo"><button class="btn_back_menu btn_back">Menu</button><button class="boton" id="exp">Exploro</button><button class="boton" id="jue">Juego</button></div>',
